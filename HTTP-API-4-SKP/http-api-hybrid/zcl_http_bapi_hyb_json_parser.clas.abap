CLASS zcl_http_bapi_hyb_json_parser DEFINITION
  PUBLIC
  CREATE PUBLIC.

* Thin wrapper around the kernel sXML + CALL TRANSFORMATION id pipeline.
* Single, testable, released-API entry point for JSON <-> ABAP in the
* http-api-hybrid project. Nothing else in this project touches
* /ui2/cl_json.
...
CLASS zcl_http_bapi_hyb_json_parser IMPLEMENTATION.
