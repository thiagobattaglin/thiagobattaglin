CLASS zcl_bapi_dyn_dispatcher DEFINITION
  PUBLIC
  CREATE PUBLIC.
  ...
  PROTECTED SECTION.
    ...
    "! Hook overridden by tests to avoid real RFC dispatch.
...
CLASS zcl_bapi_dyn_dispatcher IMPLEMENTATION.
  ...
  METHOD dispatch_chunks.
    ...
    LOOP AT it_chunks ASSIGNING FIELD-SYMBOL(<lv_chunk>).
      ...
      TRY.
          CALL FUNCTION 'Z_BAPI_DYN_WORKER'
