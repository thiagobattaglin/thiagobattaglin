...
*"* declarations
CLASS lhc_bapi_ctf_run DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  PRIVATE SECTION.
    ...
    METHODS persist_run
      IMPORTING is_outcome     TYPE zcl_bapi_ctf_dispatcher=>ty_outcome
                iv_wt          TYPE i
                iv_wr          TYPE i
                iv_status      TYPE c
...
CLASS lhc_bapi_ctf_run IMPLEMENTATION.
  ...
  METHOD submit.
    ...
    LOOP AT keys ASSIGNING FIELD-SYMBOL(<key>).
      ...
      TRY.
          DATA(lo_dispatcher) = NEW zcl_bapi_ctf_dispatcher( ).
  ...
  METHOD persist_run.
    ...
    MODIFY ENTITIES OF zr_bapi_ctf_run IN LOCAL MODE
      ENTITY BapiRun
